...
namespace FantasyIsland.Characters
{
    ...
    public class Player : IPlayer
    {
        ...
        public Weapon Weapon
        {
            get
            {
                return new Weapon(this.weapon.WeaponStats.AttackPower, this.weapon.WeaponStats.Accuracy, this.weapon.WeaponStats.Defence, this.Weapon.Weight, this.weapon.Strength);
            }
            set
            {
                this.weapon = value;
